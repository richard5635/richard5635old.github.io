...
import { ContentWrapper, SubContentWrapper, HeaderImage, HeaderImageWrapper,TextRow, IFrameWrapper } from './../components/Layout'
            ...
            <ContentWrapper>
                ...
                <SubContentWrapper>
                    <div className="container-fluid">
                        ...
                        <TextRow className="row">
                            <div className="col">
                                <Header3><b>This is Header 3</b></Header3>
                                <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vestibulum arcu sit amet ipsum porta, et luctus nisi imperdiet. Duis dictum tincidunt tincidunt. Nulla iaculis accumsan tellus, a finibus ante sodales eget. Fusce sed interdum nunc. Vestibulum euismod ipsum sagittis nunc varius dignissim. </Text>
                            </div>
                            <div className="col">
                                <Text>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vestibulum arcu sit amet ipsum porta, et luctus nisi imperdiet. Duis dictum tincidunt tincidunt. Nulla iaculis accumsan tellus, a finibus ante sodales eget. Fusce sed interdum nunc. Vestibulum euismod ipsum sagittis nunc varius dignissim. </Text>
                            </div>
                        </TextRow>
